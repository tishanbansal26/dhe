        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl tracking-tight text-white">Radhe<span className="text-teal-400">Invest</span></span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/#plans" className="text-gray-400 hover:text-teal-400 transition-colors text-sm flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-teal-500/50"></span>Insurance Plans</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-gray-400 text-sm">
                ...
                <span>123 Finance Hub, Tech Park Phase 2,<br/>Mumbai, Maharashtra 400001</span>
              </li>
              <li className="flex items-center gap-3 text-gray-400 text-sm">
                <Phone className="w-5 h-5 text-teal-400 shrink-0" />
                <a href="tel:18001234567" className="hover:text-teal-400 transition-colors">1800-123-4567 (Toll Free)</a>
              </li>
              <li className="flex items-center gap-3 text-gray-400 text-sm">
                <Mail className="w-5 h-5 text-teal-400 shrink-0" />
                <a href="mailto:support@radheinvest.com" className="hover:text-teal-400 transition-colors">support@radheinvest.com</a>
              </li>
            </ul>
          </div>
